...
from datasets.firearm import firearm
...
for year in ['2007', '2012']:
  for split in ['train', 'val', 'trainval', 'test']:
    ...
    __sets[name] = (lambda split=split: pascal_voc(split, year))



for split in ['train', 'val', 'trainval', 'test']:
    name = 'firearm_{}'.format(split)
    __sets[name] = (lambda split=split, year=year: firearm(split))
